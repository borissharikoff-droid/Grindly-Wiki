...
(function() {
  var SEARCH_INDEX = [
    ...
    { name: 'Hot Zone', url: 'arena.html', cat: 'Arena', icon: '\u{1F525}' },
    { name: 'Raids', url: 'raids.html', cat: 'Page', icon: '\u2694\uFE0F' },
    { name: 'Guilds', url: 'guilds.html', cat: 'Page', icon: '\u{1F3F0}' },
    { name: 'Ancient Raid', url: 'raids.html', cat: 'Raids', icon: '\u{1FAA8}' },
    { name: 'Mythic Raid', url: 'raids.html', cat: 'Raids', icon: '\u{1F432}' },
    { name: 'Eternal Raid', url: 'raids.html', cat: 'Raids', icon: '\u26A1' },
    { name: 'Ancient Golem', url: 'raids.html', cat: 'Raids', icon: '\u{1FAA8}' },
    { name: 'Mythic Hydra', url: 'raids.html', cat: 'Raids', icon: '\u{1F432}' },
    { name: 'Eternal Titan', url: 'raids.html', cat: 'Raids', icon: '\u26A1' },
    { name: 'Raid Ancient Ring', url: 'raids.html', cat: 'Raids', icon: '\u{1F48D}' },
    { name: 'Raid Void Blade', url: 'raids.html', cat: 'Raids', icon: '\u2694\uFE0F' },
    { name: 'Raid Eternal Crown', url: 'raids.html', cat: 'Raids', icon: '\u{1F451}' },
    { name: 'Guild Buffs', url: 'guilds.html', cat: 'Guilds', icon: '\u26A1' },
    { name: 'Guild Tax', url: 'guilds.html', cat: 'Guilds', icon: '\u{1FA99}' },
    { name: 'Guild Chest', url: 'guilds.html', cat: 'Guilds', icon: '\u{1F381}' },
    { name: 'Daily Quests', url: 'quests.html', cat: 'Page', icon: '\u{1F3AF}' },
    { name: 'Weekly Challenges', url: 'quests.html', cat: 'Quests', icon: '\u{1F4C5}' },
    { name: 'Quest Streak', url: 'quests.html', cat: 'Quests', icon: '\u{1F525}' },
    { name: 'Focus Sprint', url: 'quests.html', cat: 'Quests', icon: '\u{1F3AF}' },
    { name: 'Dungeon Run Quest', url: 'quests.html', cat: 'Quests', icon: '\u2694\uFE0F' },
    { name: 'Achievements', url: 'achievements.html', cat: 'Page', icon: '\u{1F3C6}' },
    { name: 'Grind Lord', url: 'achievements.html', cat: 'Achievements', icon: '\u{1F451}' },
    { name: 'Streak Master', url: 'achievements.html', cat: 'Achievements', icon: '\u26A1' },
    { name: 'Dragon Slayer', url: 'achievements.html', cat: 'Achievements', icon: '\u{1F409}' },
    { name: 'Jack of All Trades', url: 'achievements.html', cat: 'Achievements', icon: '\u{1F52E}' },
    { name: 'Marketplace', url: 'marketplace.html', cat: 'Page', icon: '\u{1F6D2}' },
    { name: 'Order Book', url: 'marketplace.html', cat: 'Marketplace', icon: '\u{1F4D6}' },
    { name: 'Floor Price', url: 'marketplace.html', cat: 'Marketplace', icon: '\u{1FA99}' },
    { name: 'List for Sale', url: 'marketplace.html', cat: 'Marketplace', icon: '\u{1F4B0}' },
    { name: 'Friends', url: 'friends.html', cat: 'Page', icon: '\u{1F465}' },
    { name: 'Activity Feed', url: 'friends.html', cat: 'Friends', icon: '\u{1F4E1}' },
    { name: 'Leaderboard', url: 'friends.html', cat: 'Friends', icon: '\u{1F3C5}' },
    { name: 'Add Friend', url: 'friends.html', cat: 'Friends', icon: '\u{1F91D}' },
    { name: 'Activity Tracker', url: 'tracker.html', cat: 'Page', icon: '\u{1F4BB}' },
    { name: 'Idle Detection', url: 'tracker.html', cat: 'Tracker', icon: '\u{1F4A4}' },
    { name: 'Skill Categories', url: 'tracker.html', cat: 'Tracker', icon: '\u{1F3AF}' },
